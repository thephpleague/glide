...
class CropTest extends TestCase
{
    ...
    public function testGetCoordinates()
    {
        ...
        $this->assertNull($this->manipulator->setParams(['crop' => null])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '1,1,1,'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '1,1,,1'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '1,,1,1'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => ',1,1,1'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '-1,1,1,1'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '1,1,101,1'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => '1,1,1,101'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => 'a'])->getCoordinates($this->image));
        $this->assertNull($this->manipulator->setParams(['crop' => ''])->getCoordinates($this->image));
    }
