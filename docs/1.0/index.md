...
<p class="message-notice">Version 1.0 is no longer actively maintained. Consider using <a href="/">latest version</a> instead.</p>
...
![© Photo Joel Reynolds](/images/kayaks-gam-p9_sharp-8_w-1000.jpg?w=1000&gam=.9&sharp=8)
